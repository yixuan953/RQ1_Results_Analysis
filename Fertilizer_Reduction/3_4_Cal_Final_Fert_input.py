...
os.makedirs(f"{Output_dir}/Inc_prop", exist_ok=True)
...
for basin in Basins:
    ...
    for crop in CropTypes:
        ...
        red_prop_dir = os.path.join(Output_dir, f"Inc_prop/{basin}_{crop}_Fert_inc_prop.nc")
        ...
        N_red_prop = red_prop_nc["Fert_inc_prop"]
        ...
        output_nc = os.path.join(Output_dir, f"Inc_prop/{basin}_{cropname2}_Fert_2005-2020_FixRate.nc")
