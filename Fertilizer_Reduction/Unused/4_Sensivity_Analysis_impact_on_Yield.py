...
cropland_type = "Irrigated" # or "Rainfed"
...
red_csv_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/2_3_Sus_Irri_Red_Fert"
red_scenario = ["Red_org", "Red_08", "Red_15", "Red_20", "Red_30", "Red_50"]  # ["Red_org", "Red_08", "Red_09", "Red_11", "Red_12", "Red_13", "Red_14", "Red_15", "Red_20", "Red_25", "Red_30", "Red_35", "Red_40", "Red_50"]
...
for basin in studyareas:
    for crop in croptypes:
        ...
        for scen_name, csv_dir in all_csv_dirs:
            ...
            ha_valid = ha_df[~ha_df["Harvest_Area"].isna() & ha_df["Harvest_Area"] > 2500][["lat", "lon", "Harvest_Area"]]
            merged = avg_df.merge(
        ...
        if scenario_weighted:
            ...
            ys = [float(scenario_weighted[s]["Storage"]) for s in scen_names]
            ...
            out_png = os.path.join(output_dir, f"{basin}_{crop}_{cropland_type}_Nfert_Yield.png")
            plt.tight_layout()
