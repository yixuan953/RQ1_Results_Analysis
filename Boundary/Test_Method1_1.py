...
monthly_runoff = ds_monthly_runoff["OUT_RUNOFF"]
pixel_area = ds_pixel_area["area"]

# Calculate the total N load through runoff (kg)
total_N_load = monthly_runoff * pixel_area * N_crit_conc_runoff  * 0.000001
total_P_load = monthly_runoff * pixel_area * P_crit_conc_runoff  * 0.000001
